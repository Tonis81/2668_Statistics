...
diabet2 <- read_spss(here("data", "diabet2.sav"))
```
...
```{r, include=FALSE}
library(haven)
dt <- read_spss(here("data", "Estudiantes1.sav"))
dim(dt)
```
...
```{r, include=FALSE}
library(haven)
datos <- read_spss(here("data", "Estudiantes1.sav"))
```
...
save(submujer, file = here("data", "submujer.Rdata"))
write.csv(submujer, file = here("data", "submujer.csv"))
```
...
```{r, include=FALSE}
library(haven)
diab <- read_spss(here("data", "diabet2.sav"))
```
...
names(subestu)
dim(subestu)
save(subestu, file = here("data", "subestu.Rdata"))
```
...
dim(submujerdiet)
save(submujerdiet, file = here("data", "submujerdiet.Rdata"))
write.csv(submujerdiet, file = here("data", "submujerdiet.Rdata"))
```
...
```{r, include=FALSE}
library(haven)
base1 <- read_spss(here("data", "Base1-3.sav"))
dim(base1)
base2 <- read_spss(here("data", "Base2-2.sav"))
dim(base2)
names(base1)
