...
```{r}
iriscsv <- read.csv(here("data", "iriscsv.csv"))
```

```{r}
library(readxl)
irisxlsx <- read_excel(here("data", "irisxlsx.xlsx") , sheet="data", col_names= TRUE)
```
...
irisxlsx_NAs <- read_excel(here("data", "irisxlsx_NAs.xlsx") , sheet="data", col_names= TRUE)
